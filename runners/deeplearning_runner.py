...
def parse_args():
    ...
    p.add_argument("--dim-config", type=str, default="configs/dimensionality_reduction/deeplearning.yaml")
...
def main():
    ...
    print_header("Deep Learning Runner")
    ...
    if args.mode == "synthetic":
        ...
        dataset_name = f"synthetic_deeplearning_{gt_sorting.get_num_units()}units"
    else:
        ...
        X, peak_locations, meta = prepare_spike_features(recording, args.threshold)
        y = None
        dataset_name = "real_deeplearning"
    ...
    save_metadata(Path(args.output_dir), recording, meta, args.mode, args.subset_duration, "deeplearning_runner_metadata.json")
